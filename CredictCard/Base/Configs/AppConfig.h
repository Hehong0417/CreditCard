...
//才艺榜
#define kNotificationDidTalentList @"kNotificationDidTalentList"
...
//按节购买
#define kNotificationPurchaseByLesson @"kNotificationPurchaseByLesson"
...
typedef enum : NSUInteger {
    ApplyType_changeIdentify,//切换身份
    ApplyType_register,//注册类型
    ApplyType_login,    //登录类型（登录、微信登录）
    ApplyType_auditFail    //登录类型（登录、微信登录）
