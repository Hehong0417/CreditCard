...
typedef enum : NSUInteger {
    ...
    HXCommonPickViewStyleTeachingtype,
    HXCommonPickViewStyleWithDrawWay,
    HXCommonPickViewStyleTeachingYears,
    HXCommonPickViewStyleEducation,
    HXCommonPickViewStyleTalentvideotype,
    HXCommonPickViewStylechapterCount
