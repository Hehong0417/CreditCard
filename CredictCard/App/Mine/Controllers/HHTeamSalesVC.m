...
@interface HHTeamSalesVC ()<UITableViewDelegate,UITableViewDataSource,UISearchControllerDelegate,UISearchResultsUpdating,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
- (void)viewDidLoad {
    ...
    self.searchController.searchBar.placeholder = @"搜索成员名称";
    ...
    self.tableView = [[UITableView alloc]initWithFrame:CGRectMake(0,self.searchController.searchBar.mj_h, SCREEN_WIDTH,tableHeight) style:UITableViewStyleGrouped];
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"HHTeamSalesCell" bundle:nil] forCellReuseIdentifier:@"HHTeamSalesCell"];
...
- (void)getDatas{
    ...
    [[[HHPerCenterDataAPI  getSubordinateSaleListWithPage:@(self.page) name:self.name] netWorkClient] getRequestInView:nil finishedBlock:^(HHPerCenterDataAPI *api, NSError *error) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HHTeamSalesCell *cell = [tableView dequeueReusableCellWithIdentifier:@"HHTeamSalesCell"];
