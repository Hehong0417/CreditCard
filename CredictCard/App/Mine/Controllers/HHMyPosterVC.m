...
@interface HHMyPosterVC ()<UIWebViewDelegate,NJKWebViewProgressDelegate>
{
...
- (void)viewDidLoad {
    ...
    [[[HHPerCenterDataAPI getGetQRCode] netWorkClient] getRequestInView:nil finishedBlock:^(HHPerCenterDataAPI *api, NSError *error) {
...
- (void)shareVedioToPlatformType:(UMSocialPlatformType)platformType
{
    ...
    //创建Webpage内容对象
    UMShareWebpageObject *shareObject = [UMShareWebpageObject shareObjectWithTitle:@"我的海报" descr:@"" thumImage:nil];
